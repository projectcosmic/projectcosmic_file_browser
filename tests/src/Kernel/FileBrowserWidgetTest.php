...
namespace Drupal\Tests\projectcosmic_file_browser\Kernel;
 ...
 *
 * @group projectcosmic_file_browser
 * @requires module entity_browser
 */
class FileBrowserWidgetTest extends EntityKernelTestBase {

  /**
   * {@inheritdoc}
   */
  public static $modules = [
    'projectcosmic_file_browser',
    'entity_browser',
    'image',
    'file',
  ];
